...
<Project Type="Project" LVVersion="17008000">
	<Property Name="CCSymbols" Type="Str">ERROR,OFF;</Property>
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Algorithms" Type="Folder">
			<Item Name="Process Heartbeat Waveform.vi" Type="VI" URL="../Main Demo/Process Heartbeat Waveform.vi"/>
			<Item Name="Remove outliars before calculations.vi" Type="VI" URL="../Main Demo/Remove outliars before calculations.vi"/>
			<Item Name="Calculate Blood Pressure.vi" Type="VI" URL="../Main Demo/Calculate Blood Pressure.vi"/>
			<Item Name="Peak-Valley-Noise.vi" Type="VI" URL="../Main Demo/Peak-Valley-Noise.vi"/>
		</Item>
		<Item Name="SubVIs" Type="Folder">
			<Item Name="Find Blood Pressure_ms.vi" Type="VI" URL="../Main Demo/Find Blood Pressure_ms.vi"/>
			<Item Name="Initialize BPMeaurement.vi" Type="VI" URL="../Main Demo/Initialize BPMeaurement.vi"/>
			<Item Name="Logging Slope.vi" Type="VI" URL="../Main Demo/Logging Slope.vi"/>
			<Item Name="Reset Display.vi" Type="VI" URL="../Main Demo/Reset Display.vi"/>
			<Item Name="Send Debug Info to DETT.vi" Type="VI" URL="../Main Demo/Send Debug Info to DETT.vi"/>
			<Item Name="Update cursors.vi" Type="VI" URL="../Main Demo/Update cursors.vi"/>
			<Item Name="Clear Graph.vi" Type="VI" URL="../Main Demo/Clear Graph.vi"/>
			<Item Name="Find Blood Pressure_ms.lvtest" Type="TestItem" URL="../../../../../../Program Files (x86)/National Instruments/LabVIEW 2017/ProjectTemplates/Source/Software Engineering/Main Demo/Find Blood Pressure_ms.lvtest">
				<Property Name="utf.test.bind" Type="Str">Find Blood Pressure_ms.vi</Property>
				<Property Name="utf.vector.test.bind" Type="Str">03646D48-6D18-7061-A2FC-0207C3EA94D8</Property>
			</Item>
		</Item>
		<Item Name="Sample Data" Type="Folder">
			<Item Name="BP DATA exp 3 123x76 62 BPM.tdms" Type="Document" URL="../Sample Data/BP DATA exp 3 123x76 62 BPM.tdms"/>
		</Item>
		<Item Name="Requirements Documents" Type="Folder">
			<Item Name="Blood Pressure Requirements - Detailed Software Design.doc" Type="Document" URL="../Requirements Documents/Blood Pressure Requirements - Detailed Software Design.doc"/>
			<Item Name="Blood Pressure Requirements - Hardware.doc" Type="Document" URL="../Requirements Documents/Blood Pressure Requirements - Hardware.doc"/>
			<Item Name="Blood Pressure Requirements - Software Unit Tests.doc" Type="Document" URL="../Requirements Documents/Blood Pressure Requirements - Software Unit Tests.doc"/>
			<Item Name="Blood Pressure Requirements - System Level.doc" Type="Document" URL="../Requirements Documents/Blood Pressure Requirements - System Level.doc"/>
			<Item Name="Blood Pressure Requirements - User.doc" Type="Document" URL="../Requirements Documents/Blood Pressure Requirements - User.doc"/>
			<Item Name="NIBP Monitor.rqtf" Type="Document" URL="../Requirements Documents/NIBP Monitor.rqtf"/>
		</Item>
		<Item Name="Type Definitions" Type="Folder">
			<Item Name="Heart Rate Parameters.ctl" Type="VI" URL="../Custom Controls/Heart Rate Parameters.ctl"/>
			<Item Name="State Control.ctl" Type="VI" URL="../Custom Controls/State Control.ctl"/>
		</Item>
		<Item Name="Demonstration Script" Type="Folder">
			<Item Name="Software Engineering Technical Manual and Exercises.pdf" Type="Document" URL="../Software Engineering Technical Manual and Exercises.pdf"/>
		</Item>
		<Item Name="Slides" Type="Folder">
			<Item Name="Software Engineering with LabVIEW.pptx" Type="Document" URL="../Slides/Software Engineering with LabVIEW.pptx"/>
		</Item>
		<Item Name="Code Reviews" Type="Folder">
			<Item Name="Trace Configuration.ini" Type="Document" URL="../Code Reviews/Trace Configuration.ini"/>
			<Item Name="VI Analyzer Test Configuration.cfg" Type="Document" URL="../Code Reviews/VI Analyzer Test Configuration.cfg"/>
		</Item>
